...
#crop the data so that it quicker to process and is the size and shape of the 
#LiDAR data


# Crop the raster to the extent of the polygon
S2.10m <- terra::mask(S2.10m, kat_boundary)
...
# convert to a dataframe for the ML section
